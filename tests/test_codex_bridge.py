...
from linux_remote_tool.codex_bridge import main
...
def test_codex_bridge_invoke_uses_inline_json(monkeypatch, capsys):
    monkeypatch.setattr(
        "linux_remote_tool.codex_bridge.adapter.invoke",
...
def test_codex_bridge_reports_tool_errors(monkeypatch, capsys):
    ...
    monkeypatch.setattr("linux_remote_tool.codex_bridge.adapter.invoke", raise_exc)
