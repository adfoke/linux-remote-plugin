...
@patch("linux_remote_tool.runtime_adapter.list_hosts")
...
@patch("linux_remote_tool.runtime_adapter.run_command")
...
@patch("linux_remote_tool.runtime_adapter.test_connection_batch")
...
@patch("linux_remote_tool.runtime_adapter.run_command_batch")
...
@patch("linux_remote_tool.runtime_adapter.upload_file")
...
@patch("linux_remote_tool.runtime_adapter.upload_file_batch")
...
@patch("linux_remote_tool.runtime_adapter.download_file_batch")
...
@patch("linux_remote_tool.runtime_adapter.query_audit_logs")
